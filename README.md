...
|:--------|:--------:|:--------:|:--------:|:--------:|
|  ![Star](https://img.shields.io/github/stars/MM-UAVBench/MM-UAVBench.svg?style=social&label=Star) <br> [**MM-UAVBench: How Well Do Multimodal Large Language Models See, Think, and Plan in Low-Altitude UAV Scenarios?**](https://arxiv.org/abs/2512.23219) <br> Shiqi Dai, Zizhi Ma, Zhicong Luo, Xuesong Yang, Yibin Huang, Wanyue Zhang, Chi Chen, Zonghao Guo, Wang Xu, Yufei Sun, Maosong Sun <br>| arXiv | 2025-12-29 | [Github](https://github.com/MM-UAVBench/MM-UAVBench) | - |
|  ![Star](https://img.shields.io/github/stars/EmbodiedCity/Open3D-VQA.code.svg?style=social&label=Star) <br> [**Open3D-VQA: A Benchmark for Embodied Spatial Concept Reasoning with Multimodal Large Language Model in Open Space**](https://dl.acm.org/doi/abs/10.1145/3746027.3758219) <br> Weichen Zhang, Zile Zhou, Xin Zeng, Xuchen Liu, Jianjie Fang, Chen Gao, Yong Li, Jinqiang Cui, Xinlei Chen, Xiao-Ping Zhang <br>| ACM MM | 2025-10-27 | [Github](https://github.com/EmbodiedCity/Open3D-VQA.code) | - |
...
|  ![Star](https://img.shields.io/github/stars/ZhanYang-nwpu/UAVBench-and-UAVIT-1M.svg?style=social&label=Star) <br>[**UAVBench and UAVIT-1M: Benchmarking and Enhancing MLLMs for Low-Altitude UAV Vision-Language Understanding**](https://arxiv.org/abs/2603.14336) <br>Yang Zhan, Yuan Yuan  <br>| arXiv | 2025-05-13 | [Github](https://github.com/ZhanYang-nwpu/UAVBench-and-UAVIT-1M)  | [Project page](https://UAVBench.github.io/) |


## Agents for UAV Visual Perception
|  Title  |   Venue  |   Date   |   Code   |   Note   |
|:--------|:--------:|:--------:|:--------:|:--------:|
|  [**Multimodal Large Language Models-Enabled UAV Swarm: Towards Efficient and Intelligent Autonomous Aerial Systems**](https://ieeexplore.ieee.org/abstract/document/11301765) <br>Ping, Y., Liang, T., Ding, H., Lei, G., Wu, J., Zou, X., ... & Zhang, T.  <br>| IEEE WC | 2025-12-16 | [YouTube](https://www.youtube.com/watch?v=zwnB9ZSa5A4) | - |
